...
const skills = [
  {
    component: <DiHtml5 color={"var(--color-emerald)"} size={34} />,
    title: "HTML5",
    description:
  ...
  {
    component: <LiaCss3Alt color={"var(--color-red)"} size={34} />,
    title: "CSS3",
    description:
  ...
  {
    component: <LiaJsSquare color={"var(--color-yellow)"} size={34} />,
    title: "JavaScript",
    description:
  ...
  {
    component: <BiLogoTypescript color={"var(--color-sapphire)"} size={34} />,
    title: "TypeScript",
    description:
  ...
  {
    component: <SiNextdotjs color={"var(--color-foreground)"} size={34} />,
    title: "Next.js",
    description:
  ...
  {
    component: <BiLogoMongodb color={"var(--color-orange)"} size={34} />,
    title: "MongoDB",
    description:
  ...
  {
    component: <BiLogoFirebase color={"var(--color-red)"} size={34} />,
    title: "Firebase",
    description:
  ...
  {
    component: <BiLogoTailwindCss color={"var(--color-sapphire)"} size={34} />,
    title: "Tailwind CSS",
    description:
  ...
  {
    component: <DiSass color={"var(--color-berry)"} size={34} />,
    title: "Sass",
    description:
  ...
  {
    component: <GithubIcon color={"black"} size={34} />,
    title: "GitHub",
    description:
  ...
  {
    component: <FaNodeJs color={"var(--color-emerald)"} size={34} />,
    title: "Node.js",
    description:
  ...
  {
    component: <LiaNpm color={"var(--color-red)"} size={34} />,
    title: "npm",
    description:
  ...
  {
    component: <SiVisualstudiocode color={"var(--color-ocean)"} size={34} />,
    title: "VSCode",
    description:
  ...
  {
    component: <SiPostman color={"var(--color-orange)"} size={34} />,
    title: "API/REST API",
    description:
  ...
  {
    component: <GiGemini color={"var(--color-berry)"} size={34} />,
    title: "Gemini API",
    description:
